...
from network.segmentator_3d_asymm_spconv import U2NET, UNET, U2NETP, U2NETP2, U2NETL, U2NETLPLUS
...
def build(model_config):
    ...
    if model_config['model_name'] == 'U2NET':
        cylinder_3d_spconv_seg = U2NET(
            ...
            init_size=init_size,
            nclasses=num_class)
    elif model_config['model_name'] == 'U2NETL':
        cylinder_3d_spconv_seg = U2NETL(
            output_shape=output_shape,
            num_input_features=num_input_features,
            init_size=init_size,
            nclasses=num_class)
    elif model_config['model_name'] == 'U2NETLPLUS':
        cylinder_3d_spconv_seg = U2NETLPLUS(
            output_shape=output_shape,
            num_input_features=num_input_features,
            init_size=init_size,
            nclasses=num_class)
